...
namespace MilkMatrix.Milk.Models.Request.Inventory.Item
{
    public class ItemUpdateRequest
    {
        ...
        public List<DairySpecUpdateRequest> DairySpecs { get; set; } = new();
        public List<ItemLocationUpdateRequest> Locations { get; set; } = new();
    }

    public class DairySpecUpdateRequest
    {
        public int? BusinessId { get; set; }
    ...
    public class ItemLocationUpdateRequest
    {
        public int? BusinessId { get; set; }
